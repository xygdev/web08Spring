...
public class IrrController {
    ...
    //对应旧的：/getDefaultIRR
    //http://localhost:8080/web08Spring/irr/getDefaultIrr.do?USER_ID=123456
	@RequestMapping(value = "/getDefaultIrr.do", method = RequestMethod.GET)
	...
	//对应旧的：/getUserIRR
	@RequestMapping(value = "/getIrrHead.do", method = RequestMethod.GET)
	...
	//对应旧的 /getIRR
	@RequestMapping(value = "/getIrr.do", method = RequestMethod.GET)
