            ...
            <ul>
              <li>
                <a class="set_page_size pointer" data-pagetype="setpagesize" data-pageframe=<%=pageframe %>>
                  <i class="fa fa-dot-circle-o hidden" aria-hidden="true" data-value="5"></i>5
                </a>
              </li>
              <li>
                <a class="set_page_size pointer" data-pagetype="setpagesize" data-pageframe=<%=pageframe %>>
                  <i class="fa fa-dot-circle-o" aria-hidden="true" data-value="10"></i>10
                </a>
              </li>
              <li>
                <a class="set_page_size pointer" data-pagetype="setpagesize" data-pageframe=<%=pageframe %>>
                  <i class="fa fa-dot-circle-o hidden" aria-hidden="true" data-value="15"></i>15
                </a>
              </li>
              <li>
                <a class="set_page_size pointer" data-pagetype="setpagesize" data-pageframe=<%=pageframe %>>
                  <i class="fa fa-dot-circle-o hidden" aria-hidden="true" data-value="25"></i>25
                </a>
              </li>
              <li>
                <a class="set_page_size pointer" data-pagetype="setpagesize" data-pageframe=<%=pageframe %>>
                  <i class="fa fa-dot-circle-o hidden" aria-hidden="true" data-value="50"></i>50
                </a>
              </li> 
            </ul>
          </li>
