     ...
     <div id='uf' class='update_frame'>     
       ...
       <div class='content'>
         <form id='updateData'>
           ...
           <input type='text' id='JOB_NAME' name='JOB_NAME' class='left short' data-modify='true' required='required' data-pageframe="uf" data-validurl='lov/validJobName.do' data-queryurl='lov/getJobId.do' data-lovbtn='JOB_LOV' data-hiddenid='JOB_ID' data-queryparam=["jobname","JOB_ID"]>
           ...
           <input type='text' id='DEPT_NAME' name='DEPT_NAME' class='left short' data-modify='true' required='required' data-pageframe="uf" data-validurl='lov/validDeptName.do' data-queryurl='lov/getDeptId.do' data-lovbtn='DEPT_LOV' data-hiddenid='DEPARTMENT_ID' data-queryparam=["deptname","DEPT_ID"]>
